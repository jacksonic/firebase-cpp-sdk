 ...
 *
 * <p>The primary use case for this class is for C++ to store "global references" to objects without
 ...
 *
 * <p>This class is thread safe and may be safely used concurrently by multiple threads. This thread
 * safety is achieved by marking each public method as {@code synchronized}. Therefore, any
 * newly-added public methods must also be marked as {@code synchronized}.
 */
public final class ObjectArena {
   ...
   * Removes an object.
   *
   * <p>If the given key is unassigned, then this method does nothing.
   *
   ...
   *
   * <p>The object associated with the given key will be re-added and will be assigned another
  ...
  /**
   * Returns the number of objects in this arena.
   *
   * @return the number of objects that have been added and not removed.
   */
